...
class UpdateProfileRequestMapper extends ClassMapperBase<UpdateProfileRequest> {
  ...
  static const Field<UpdateProfileRequest, String> _f$name = Field(
    'name',
    _$name,
    opt: true,
  );
  static String? _$bio(UpdateProfileRequest v) => v.bio;
  static const Field<UpdateProfileRequest, String> _f$bio = Field(
    'bio',
    _$bio,
    opt: true,
  );
  static String? _$phoneNumber(UpdateProfileRequest v) => v.phoneNumber;
  static const Field<UpdateProfileRequest, String> _f$phoneNumber = Field(
    'phoneNumber',
    _$phoneNumber,
    opt: true,
  );
...
mixin UpdateProfileRequestMappable {
  ...
  UpdateProfileRequestCopyWith<
    UpdateProfileRequest,
    UpdateProfileRequest,
    UpdateProfileRequest
  >
  get copyWith =>
      _UpdateProfileRequestCopyWithImpl<
        UpdateProfileRequest,
        UpdateProfileRequest
      >(this as UpdateProfileRequest, $identity, $identity);
  @override
  String toString() {
    return UpdateProfileRequestMapper.ensureInitialized().stringifyValue(
      this as UpdateProfileRequest,
    );
  }

  @override
  bool operator ==(Object other) {
    return UpdateProfileRequestMapper.ensureInitialized().equalsValue(
      this as UpdateProfileRequest,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return UpdateProfileRequestMapper.ensureInitialized().hashValue(
      this as UpdateProfileRequest,
    );
  }
}
