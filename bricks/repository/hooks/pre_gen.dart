...
/// Require the supported REST foundation before rendering repository files.
void run(HookContext context) {
  final problem = _validateCapability();
  if (problem == null) return;
  final message =
      '$problem REST repository generation requires dio_rest. '
      'Run `mason make dio_rest` from the project root and retry. No repository '
